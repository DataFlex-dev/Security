...
Deferred_View Activate_oFileEncrypt for ;
Object oFileEncrypt is a View

    Set Border_Style to Border_Normal
    Set Size to 284 455
    Set Location to 2 2
    Set Label to "File encryption"
